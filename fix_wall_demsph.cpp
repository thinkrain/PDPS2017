...
FixWallDEMSPH::FixWallDEMSPH(PDPS *ps, int narg, char **arg) : Fix(ps, narg, arg)
{
...
void FixWallDEMSPH::set_pairlist()
{
	int ipair;
	int itag;
	int dim, side;
...
void FixWallDEMSPH::tag2str(char *str, int itag, int iwall)
{
...
void FixWallDEMSPH::pre_force_dem_lsd(int ipair, int iparticle, double delta, double *n, int iwall)
{
	int table, index;
